...
from types import List, Optional, Dict, List
    ...
    def _create_widgets(self):
        ...
        for field_def in self.fields_def:
            ...
            if field_def.field_type == 'text':
                ...
                widget = ttk.Combobox(self, values=field_def.optoins or [], width=field_def.width, state='readonly')
    ...
    def _layout_widgets(self):
        ...
        for field_def in self.fields_def:
            ...
            ttk.Label(self, text=label_text).grid(
                row=row, column=0, stickly="w", padx=(0, 10), pady=5
            )
        ...
        self.submit_btn.pack(side=tk.CENTER)
