    ...
    for states in states_array:
        ...
        if state_index < initial_frame + 60 and state_index > initial_frame + 36 and ((state_index - initial_frame ) % 2 == 0):
            for first_coords in usable_first_skip_tiles:
                result = cloud_location_finder(states[1], first_coords, valid_tiles)
                comparison_1 = result[0] if result != "No dust cloud" else "No dust cloud"
        ...
        for valid_first in one:
            ...
            if state_index < first_frame + 85 and  state_index > first_frame + 50 and ((state_index - initial_frame) % 2 == 0):
                for second_coords in usable_second_skip_tiles:
                    result = cloud_location_finder(states[1], second_coords, valid_tiles)
                    comparison_2 = result[0] if result != "No dust cloud" else "No dust cloud"
        ...
        for valid_second in two:
            ...
            if state_index < second_frame + 95 and state_index > second_frame + 70 and ((second_frame - state_index) % 2 == 0):
                for third_coords in usable_third_skip_tiles:
                    result = cloud_location_finder(states[1], third_coords, valid_tiles)
                    comparison_3 = result[0] if result != "No dust cloud" else "No dust cloud"
        ...
        for valid_third in three:
            ...
            if state_index < third_frame + 95 and state_index > third_frame + 55 and ((third_frame - state_index) % 2 == 1):
                for fourth_coords in usable_fourth_skip_tiles:
                    result = cloud_location_finder(states[1], fourth_coords, valid_tiles)
                    comparison_4 = result[0] if result != "No dust cloud" else "No dust cloud"
        ...
        for valid_fourth in four:
            ...
            if state_index < fourth_frame + 80 and state_index > fourth_frame + 45 and ((state_index - fourth_frame) % 2 == 1):
                for fifth_coords in usable_fifth_skip_tiles:
                    result = cloud_location_finder(states[1], fifth_coords, valid_tiles)
                    comparison_5 = result[0] if result != "No dust cloud" else "No dust cloud"
