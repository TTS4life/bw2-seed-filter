...
def skip_checker(states_array, initial_frame):
    ...
    for states in states_array:
        ...
        for valid_third in three:
            ...
            if state_index < third_frame + 95 and state_index > third_frame + 57 and ((third_frame - state_index) % 2 == 1):
...
def main():
    ...
    # ツェラーの公式を使用して曜日を計算
    user_dow = (user_day + ((13*m + 8) // 5) + y + (y >> 2) ) % 7
    print ("Day of the week:", user_dow)
